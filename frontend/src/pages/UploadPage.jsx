        ...
        <div className="min-h-screen px-6 py-12 max-w-5xl mx-auto">
                ...
                <div className="flex flex-wrap gap-4">
                    {[
                        ...
                        <button
                            ...
                            className="px-6 py-3 rounded-xl font-medium transition-all duration-300 text-left"
                            style={{
                                ...
                                boxShadow: roleType === role.value
                                    ? "0 0 24px rgba(96,165,250,0.25), inset 0 1px 0 rgba(255,255,255,0.1)"
                                    : "inset 0 1px 0 rgba(255,255,255,0.03)"
                            }}
                        >
                            {role.label}
            ...
            <div>
                <button
                    ...
                    disabled={!canProceed}
                    className="w-full text-lg py-4 rounded-xl font-semibold text-white transition-all duration-300"
                    style={{
                        background: canProceed
                            ? "linear-gradient(90deg, #4d9fff, #00d4ff)"
                ...
                >
                    {canProceed ? "Analyze My Skills →" : "Upload resume and paste job description to continue"}
                </button>
